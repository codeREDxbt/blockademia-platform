              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
                  ...
                  >
                    ...
                    {isLocked ? 'Premium Required' : (progressPercentage > 0 ? 'Continue Learning' : 'Start Learning')}
                  </Button>
                  <div className="flex gap-2 sm:gap-4">
                    <Button variant="outline" size="default" disabled={isLocked} className="flex-1 sm:flex-none">
